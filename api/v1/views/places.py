...
def get_place_by_city(city_id):
    '''
       use GET to return places in city 
    '''
...
def get_place_id(place_id):
    '''
        use GET to return place and its id 
    '''
...
def delete_place(place_id):
    '''
        DELETE place object given place_id
    '''
    place = storage.get("Place", place_id)
    if place is None:
        abort(404)
...
def create_place(city_id):
    '''
        through city association using POST create new place object 
    '''
