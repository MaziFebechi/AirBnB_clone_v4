#!/usr/bin/python3
"""To define the unnittests for models/engine/db_storage.py."""
import pep8
import models
import MySQLdb
import unittest
...
class TestDBStorage(unittest.TestCase):
    """This contains the Unittests for testing the DBStorage class."""

    @classmethod
    def setUpClass(cls):
        """Here is DBStorage testing setup.

        To instantiate new DBStorage.
        Filling DBStorage test with instances of all classes.
        """
    ...
    def tearDownClass(cls):
        """Teardown of DBStorage tests.

        To delete all instantiated tests classes.
        Wiping out DBStorage session.
        """
        if type(models.storage) == DBStorage:
    ...
    def test_all_cls(self):
        """check every method with specified cls."""
    ...
    def test_delete_none(self):
        """Testing delete method with None."""
        try:
