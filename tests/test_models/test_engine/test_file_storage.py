#!/usr/bin/python3
"""To define the unnittests for models/engine/file_storage.py."""
import os
import json
import pep8
import unittest
...
class TestFileStorage(unittest.TestCase):
    """The Unittests to test the FileStorage class."""

    @classmethod
    def setUpClass(cls):
        """The fileStorage testing setup.

        To change the name of any existing file.json.
        Reseting FileStorage objects dictionary.
        To create instances of all class types for testing.
        """
        try:
    ...
    def tearDownClass(cls):
        """Teardown of fileStorage test.

        Returning the original file.json.
    ...
    def test_attributes(self):
        """Carrying out test on attributes."""
    ...
    def test_all_cls(self):
        """Checking all method with specified cls."""
    ...
    def test_reload_no_file(self):
        """Check for reload method with no existing file.json."""
        try:
            self.storage.reload()
        except Exception:
            self.fail
    ...
    def test_delete_nonexistant(self):
        """Checks for delete method with a nonexistent object."""
        try:
